...
CREATE INDEX idx_qa_report_period_line ON qa_report(period_year, period_month, production_line_id);
...
CREATE INDEX idx_qa_summary_part ON qa_part_report_summary(part_id);
...
CREATE INDEX idx_qa_obs_part_report ON qa_part_defect_observation(part_id, qa_report_id);
CREATE INDEX idx_qa_obs_defect_part ON qa_part_defect_observation(qa_defect_type_id, part_id);
