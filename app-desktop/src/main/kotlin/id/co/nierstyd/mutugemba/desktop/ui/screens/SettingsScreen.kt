    ...
    Box(modifier = Modifier.fillMaxWidth()) {
        Column(
            ...
            SettingsSectionCard(
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                    SecondaryButton(
                        text = AppStrings.Actions.RunLoadSimulation,
                        onClick = {
                            scope.launch {
                                ...
                                feedback =
                                    if (inserted > 0) {
                                        ...
                                        UserFeedback(
                                            FeedbackType.ERROR,
                                            AppStrings.Feedback.SimulationFailed,
                                        )
                                    }
                            }
                        },
                    ...
                    SecondaryButton(
                        ...
                        onClick = {
                            scope.launch {
                                loadingMessage = AppStrings.Settings.CacheBusy
                                val ok =
                                    withContext(Dispatchers.IO) {
                                ...
                                feedback =
                                    if (ok) {
                                        ...
                                        UserFeedback(
                                            FeedbackType.ERROR,
                                            AppStrings.Feedback.CacheClearFailed,
                                        )
                                    }
                            }
                        },
                ...
                Box(
                    ...
                    Surface(
                        ...
                        Column(
                            ...
                            SkeletonBlock(width = 180.dp, height = 14.dp, color = NeutralLight)
                            SkeletonBlock(width = 220.dp, height = 14.dp, color = NeutralLight)
