...
object AppStrings {
    ...
    object Inspection {
        ...
        const val DuplicateAllowed = "Duplikat Diizinkan"
        const val DuplicateBlocked = "Duplikat Diblokir"
    ...
    object Reports {
        ...
        const val LegendEmpty = "Belum Input"
        ...
        const val DocumentPreviewTitle = "Preview Dokumen (Ringkas)"
        const val PreviewBeforePrint = "Preview Sebelum Cetak"
        ...
        const val DocumentNumberLabel = "No. Dokumen"
    ...
    object ReportsMonthly {
        ...
        const val Body =
            "Setiap kolom tanggal berisi total NG part pada hari tersebut. " +
                "Kolom total NG menampilkan akumulasi per jenis NG dan total part selama sebulan."
        ...
        const val DocumentNoLabel = "No. Dokumen"
        ...
        const val TableSubtotal = "Sub-total"
        const val TableGrandTotal = "Grand Total"
    ...
    object Settings {
        ...
        const val RulesDescription = "Sistem akan menolak input part yang sama di tanggal yang sama."
        ...
        const val DuplicateTitle = "Izinkan Input Ulang Hari yang Sama"
        const val DuplicateSubtitle = "Aktifkan jika perlu mencoba input duplikat."
