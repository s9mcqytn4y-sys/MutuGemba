...
object AppStrings {
    ...
    object Inspection {
        ...
        const val LineLockedBadge = "Input Hari Ini Terkunci"
        const val LineLockedHint = "Line ini sudah diinput hari ini. Ubah di Pengaturan jika ingin input ulang."
        const val LineLockedError = "Line ini sudah memiliki input hari ini. Form dikunci untuk mencegah input ganda."
